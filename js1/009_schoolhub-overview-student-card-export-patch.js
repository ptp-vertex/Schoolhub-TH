...
(function(){
  ...
  window.showStudentMoreMenu = function(id, btn){
    ...
    var reasonBtn=isW?'<button type="button" onclick="closeStudentMoreMenu(); showStudentWithdrawReason(\''+id+'\')" class="w-full text-left px-4 py-2.5 rounded-xl hover:bg-rose-50 text-rose-600 text-sm font-bold"><i class="fas fa-circle-info w-5"></i> ดูเหตุผล</button>':'';
    var cancelBtn=isW?'<button type="button" data-right="edit" data-action-name="เปลี่ยนสถานะนักเรียน" onclick="closeStudentMoreMenu(); cancelStudentWithdrawn(\''+id+'\')" class="w-full text-left px-4 py-2.5 rounded-xl hover:bg-emerald-50 text-emerald-600 text-sm font-bold"><i class="fas fa-user-check w-5"></i> ยกเลิกสถานะ</button>':'';
    var setBtn=!isW?'<button type="button" data-right="edit" data-action-name="เปลี่ยนสถานะนักเรียน" onclick="closeStudentMoreMenu(); confirmSetStudentWithdrawn(\''+id+'\')" class="w-full text-left px-4 py-2.5 rounded-xl hover:bg-rose-50 text-rose-600 text-sm font-bold"><i class="fas fa-user-slash w-5"></i> ตั้งเป็น...</button>':'';
  ...
  if (typeof __oldEnterAdminModeGlobal === 'function') {
